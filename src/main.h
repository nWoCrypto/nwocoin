...
static const int LAST_POW_ONLY_BLOCK = 86400;	// 180x480 	
...
static const int64_t NORMAL_MINT_PROOF_OF_STAKE_STABLE = 0.03 * COIN;	
...
static const uint256 hashGenesisBlock("00000ee9ccaa362fa0869bbc44d802981ae3d6609feccf0d5665d7cdb9bddda9");
static const uint256 hashGenesisBlockTestNet("00000ee9ccaa362fa0869bbc44d802981ae3d6609feccf0d5665d7cdb9bddda9");
...
public:
    ...
    {
        // nwocoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // nwocoin: get transaction coin age
...
public:
    ...
    // nwocoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // nwocoin: two types of block: proof-of-work or proof-of-stake
    ...
    // nwocoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // nwocoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // nwocoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // nwocoin: block index flags
    enum  
    {
